...
#---------------------------------------------------------------------------------------------------------------------#
def get_long(mensaje: str, mensaje_error: str, num_minmo: float, num_max: float, reitentos: int) -> float| None:
     contador_reintentos = 0
     numero = None
...
print(get_long("Ingrese un flotante, mayor a 1 y menor a 20: ", "Invalido, Ingrese nuevamente el numero: " , 1 , 20, 3))
